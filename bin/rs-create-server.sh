...
# rs-create-server.sh <nickname> <rs_cloud_id> <deployment_href> <server_template_href> <ec2_instance_type> <ec2_pricing> <ec2_ssh_key_href>
# e.g. rs-create-server.sh 'Starbug' 3 "https://my.rightscale.com/api/acct/7954/deployments/49302" "https://my.rightscale.com/api/acct/7954/server_templates/262048001" 't1.micro' 'on_demand' "https://my.rightscale.com/acct/7954/clouds/3/ec2_ssh_keys/182526" 'us-west-1a' "https://my.rightscale.com/acct/7954/clouds/3/ec2_security_groups/200297001"
...
[[ ! $8 ]] && echo 'No EC2 availability zone provided.' && exit 1
[[ ! $9 ]] && echo 'No EC2 security groups href provided.' && exit 1
...
ec2_pricing="$6"
ec2_ssh_key_href="$7"
ec2_availability_zone="$8"
ec2_security_group_hrefs="$9"
...
-d server[ec2_security_group_hrefs][]="$ec2_security_group_hrefs" \
